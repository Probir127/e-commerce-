...
class ProductAdmin(admin.ModelAdmin):
    list_display = ['image_preview', 'name', 'category', 'price', 'discounted_price_display', 'stock', 'available', 'featured', 'created_at']
...
class OrderAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'total_display', 'status_badge', 'payment_status_badge', 'created_at', 'invoice_link']
